...
export default async (req, res) => {
  try {
    connection.query(`select products.product_name,cart.cart_id,products.img_top,cart.total_amout as total_amount,cart.quantity,product_detail.color, (total_amout/cart.quantity)as price
